...
import com.cinema.backend.email.EmailService;
import com.cinema.backend.email.EmailTemplateName;
import com.cinema.backend.modal.role.RoleRepository;
import com.cinema.backend.modal.token.TokenRepository;
import com.cinema.backend.modal.token.entities.Token;
import com.cinema.backend.modal.user.UserMapper;
import com.cinema.backend.modal.user.UserRepository;
import com.cinema.backend.modal.user.UserService;
